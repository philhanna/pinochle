...
- **UI-14c** Each team's tricks taken shall be shown face down as a stack, in
  ...
  those tricks on the back of the stack. Whichever player is viewing, the
  stack of the team seated at the top lies to the left of the top hand and the
  other team's below the left hand. The last-trick
